...
function Hero () {
  return (
      <div>
          {/* Hero Section */}
          <div className="flex justify-center items-center h-screen bg-cover bg-center" style={{ backgroundImage: "url('/src/assets/img/bg home-d564d4b1.jpg')" }}>
          ...
          <div className="flex justify-center space-x-8 mt-8">
              <div className="bg-white shadow-lg rounded-lg ">
                  <img src="/src/assets/img/menu_item1-2fb13c58.jpg" alt="Overload Lugaw" className="w-80 h-96"/>
              </div>
              <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                  <img src="/src/assets/img/menu_item-d801e64b.jpg" alt="Combo Sulit Sarap Meals" className="w-80 h-96"/>
              </div>
          </div>
